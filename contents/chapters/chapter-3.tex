...
\end{tabular}
\caption{Uptake values for FMISO and FDG PET images from different head and neck studies. Errors are standard deviation from data within corresponding study. Remarks: $^*$ Combined SUV uptake (Primary Tumour Volume \& Lymphnodes), $^\#$ Metastasis/Lymph Nodes, $^\&$ Primary Tumour.}.
